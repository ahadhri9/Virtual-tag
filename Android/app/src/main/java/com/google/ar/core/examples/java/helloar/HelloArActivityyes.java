 ...
 */
public class HelloArActivityyes extends AppCompatActivity implements SampleRender.Renderer{
 ...
 */
class WrappedAnchorhappy {
  private Anchor anchor;
  private Trackable trackable;

  public WrappedAnchorhappy(Anchor anchor, Trackable trackable) {
    this.anchor = anchor;
