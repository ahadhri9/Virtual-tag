 ...
 */
public class HelloArActivityheart extends AppCompatActivity implements SampleRender.Renderer{

  private static final String TAG = HelloArActivity.class.getSimpleName();
  private String graf = "heart.png";
  ...
  private static float APPROXIMATE_DISTANCE_METERS = 4.0f;
  //private float dist_bat = calcdist();
  // Point Cloud
 ...
 */
class WrappedAnchorheart {
  private Anchor anchor;
  private Trackable trackable;

  public WrappedAnchorheart(Anchor anchor, Trackable trackable) {
    this.anchor = anchor;
